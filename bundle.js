...
/***/ function(module, exports, __webpack_require__) {
	...
	var _initial_state = __webpack_require__(1);
	...
	var _dot_touching = __webpack_require__(4);
	...
	var start = function start() {
	  state = _initial_state2.default.get();
	  _renderer2.default.initial_render('#screen');
	  _input2.default.bind();
	  loop();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var read = function read(external_state) {
...
/***/ function(module, exports) {
	...
	exports.default = function (state) {
	  // get the x y of selected dot
	  // get the x y of dots with the same pairing as selected dots
	  // check for collision
...
/***/ function(module, exports, __webpack_require__) {
	...
	var old_dots = [];
	var format_time = function format_time(time) {
	...
	var dots_to_html = function dots_to_html(dots) {
	  return dots.map(dot_to_html).join('\n');
	};

	var render_gameover = function render_gameover(time) {
	...
	exports.default = {
	  initial_render: function initial_render(selector) {
